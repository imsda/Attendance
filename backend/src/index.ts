...
app.use('/api/students', requireAuth, requirePageAccess('PEOPLE'), studentsRoutes);
app.use('/api/settings', requireAuth, requirePageAccess('SETTINGS'), settingsRoutes);
app.use('/api/attendance', requireAuth, requirePageAccess('TRANSACTIONS'), attendanceRoutes);
...
app.use('/api/google', requireAuth, requireAdmin, googleRoutes);
